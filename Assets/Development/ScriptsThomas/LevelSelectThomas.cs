...
public class LevelSelectThomas : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        splashScreenAnimator = GameObject.Find("SplashScreen").GetComponent<Animator>();
